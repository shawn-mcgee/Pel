...
public class GameOverMenu extends Menu {
    ...
    public GameOverMenu(int player_score) {
        this.player_score = player_score;

        game_over = new Sprite(LRJ_GAME_OVER);
        menu_button = new Sprite(LRJ_MENU_BUTTON);
        number = new Sprite(LRJ_NUMBER);

        game_over.x = (CANVAS_W - game_over.w) / 2;
        menu_button.x = (CANVAS_W - menu_button.w) / 2;

        game_over.y = CANVAS_H / 2 + menu_button.h - game_over.h;
        menu_button.y = CANVAS_H / 2 + menu_button.h + 2;
    ...
    public void onRenderImage(ImageContext context) {
        ...
        game_over.onRenderImage(context);
