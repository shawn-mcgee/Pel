...
import static lrj.core.Colors.color3i;
import static lrj.core.Colors.color4i;
import static lrj.util.StringToObject.BOOLEAN;
import static lrj.util.StringToObject.INTEGER;
...
public final class Engine implements Runnable {
    ...
    protected String
        window_string = LRJ.VERSION.toString();
    ...
    public static void init() {
        if(!INSTANCE.running) {
            INSTANCE.thread = new Thread(INSTANCE, LRJ.VERSION.toString());
